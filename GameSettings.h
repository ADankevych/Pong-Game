...
void nameEntering(RenderWindow &window, const string& message, string &playerName) {
    Font font;
...
int welcomePage(RenderWindow &window){
    ...
    textWelcome.setPosition((BOARD_WIDTH - textWelcome.getLocalBounds().width)/2, BOARD_HEIGHT/3); // textPaddle.getLocalBounds().width - width of the textPaddle
